...
<div style="width: 750px;height: 243px;margin: 50px;background-image: url('../../../img/<?php echo "$tem[gambar]";?>');">
    ...
    <p style="position: absolute; font-family: arial; font-size: 10px; color: #fff; padding-left: 85px;text-transform: uppercase; text-align: center;"> Pemerintah Provinsi <?php echo $i["prov"];?><br>Kabupaten <?php echo $i["kab"];?><br><b style="font-size: 12px"><?php echo $i["sekolah"];?></b></p>
